...
#include <memory>
#include "../temporal_editor/viewwindow.h"
...
QT_MOC_LITERAL(4, 47, 6), // "get_db"
QT_MOC_LITERAL(5, 54, 12), // "QSqlDatabase"
QT_MOC_LITERAL(6, 67, 16) // "get_current_dict"

    },
    "ViewWindow\0goback\0\0on_pushButtongoBack_clicked\0"
    "get_db\0QSqlDatabase\0get_current_dict"
};
...
void ViewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->get_db((*reinterpret_cast< QSqlDatabase(*)>(_a[1]))); break;
        case 3: _t->get_current_dict((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ViewWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ViewWindow::goback)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ViewWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ViewWindow.data,
